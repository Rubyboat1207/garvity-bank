...
public class NoChangeArea : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if(direction == Handle_Controller.Directions.Right)
        {
            editableMaterial.mainTextureScale = new Vector2(-editableMaterial.mainTextureScale.x, editableMaterial.mainTextureScale.y);
        }
